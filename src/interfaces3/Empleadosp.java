package interfaces3;
import java.util.*;
//---------------------------------------------------------------------// Interfaces Padre e Hija / Predefinida y propia...también!
	...
	public static void main(String[] args) {
		...
		System.out.println("La jefa " + jefa_Finanzas.dameNombre() + " tiene un bonus d: " + jefa_Finanzas.establece_bonus(5000));
...
//---------------------------------------------------------------------
class Empleado implements Comparable, Trabajadores{ // Implementa tambien a la interfaz padre
...
//---------------------------------------------------------------------
class Jefatura extends Empleado implements Jefes{ //Implementa a la interfaz hija
	...
	public String tomar_decisiones(String decision) { // Método de la interfaz hija
		return "Un miembro de la direccion a tomado la decision de: " + decision;
	}
	
	public double establece_bonus(double gratificacion) { // Método de la interfaz padre
		double prima = 2000;
