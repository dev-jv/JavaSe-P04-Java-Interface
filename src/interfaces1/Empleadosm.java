package interfaces1;
import java.util.*;
//---------------------------------------------------------------------//Utilizamos un interfaz predefinida
	...
	public static void main(String[] args) {
		...
		Arrays.sort(empleados); // [sort] Un método estático (utiliza a su clase) perteneciente a la clase [Arrays] y para funcionar implementa la interfaz predefinida [Comparable]
...
//---------------------------------------------------------------------
class Empleado implements Comparable{ // Implementa la interfaz [Comparable]
...
//	public int compareTo(Object miObjeto) { // Método de la interfaz Comparable utilizando "Sueldo"
//		
...
//	}
	...
	public int compareTo(Object miObjeto) { // Método de la interfaz Comparable utilizando "Id"
